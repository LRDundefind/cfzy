	...
	<div class="repayment f-s-14 c-3">
		...
		<el-card class="box-card m-t-20">
			...
			<el-form :model="repaymentInfo" label-width="70px">
				<div class="textCenter arrearsMoney">欠款总金额：{{dataInfo.notPayAmount}}</div>
				<div class="ub m-t-10">
					...
					<el-form-item class="ub-f1 m-l-30" label="还款方式">
						<el-select v-model="repaymentInfo.refundType" placeholder="请选择还款方式">
							<el-option v-for="item in keyValueData.pay_type"  :key="item.key" :label="item.value" :value="item.key"></el-option>
						</el-select>
					</el-form-item>
					<el-form-item label="还款日期" class="ub-f1 m-l-30">
						<el-date-picker v-model="repaymentInfo.refundTime" value-format="timestamp" format="yyyy-MM-dd" type="date" placeholder="选择日期">
						</el-date-picker>
					</el-form-item>
					<el-form-item label="收账账号" class="ub-f1 m-l-30">
						<el-input v-model="repaymentInfo.gatherAccount"></el-input>
					</el-form-item>
				</div>
				<div class="remarks ub">
					<el-form-item label="订单备注" class="ub-f1">
						<el-input resize="none" type="textarea" v-model="repaymentInfo.remark"></el-input>
					</el-form-item>
		...
		<el-card class="box-card m-t-20" v-if="listData">
			...
			<el-table :data="listData" stripe>
				...
				<el-table-column align="center" prop="salesAmount" label="销售金额">
				</el-table-column>
				<el-table-column align="center" prop="stayStillAmount" label="待还款">
				</el-table-column>
				<el-table-column align="center" prop="this_amount" label="还款金额">
				</el-table-column>
			</el-table>
		</el-card>
	...
	export default {
		...
		methods: {
			...
			repaymentList(){
				...
				}else if (amount && (amount<= this.dataInfo.notPayAmount)){
			...
			onClickConfirmRepayment() {
				...
				if (params.refundType && params.refundTime && params.gatherAccount) {
